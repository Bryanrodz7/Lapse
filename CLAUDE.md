...
- The **Hilt** Gradle plugin is still unverified on AGP 9.2.1 — it hooks AGP internals the same way. If it can't be made to work, the fallback is a hand-rolled container with the same shape (constructor-injected repository, ViewModel factory).
